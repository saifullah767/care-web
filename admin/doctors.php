                                    ...
                                    <table class="table table-striped">
                                        ...
                                        while($rows = mysqli_fetch_array($a)) {?>
                                            <tr>
                                                ...
                                                <td><button class="btn btn-success"><a class="text-light" href="addtodrdb.php?id=<?php echo $rows['id']?>">Accept</a></button> <button class="btn btn-danger"><a href="deletefromdrdb.php?id=<?php echo $rows['id'];?>">Reject</a></button> </td>
                                            </tr>
                                      <?php  }
                                      ?>
                                        </tbody>
