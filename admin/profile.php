...
<?php
$id = $_GET['id'];
$abc = mysqli_query($conn, "select * from doctor_tbl where id=$id");
$bcd = mysqli_num_rows($abc);
$rows = mysqli_fetch_array($abc);
                ...
                <section class="boxs-simple">
                    <div class="profile-header">
                        <div class="profile_info">
                            <div class="profile-image"> <img style="width: 100px; height: 130px" src="assets/dr_imgs/<?php echo $rows['pic'] ?>" alt=""> </div>
                            <h4 class="mb-0 mt-4"><strong>Dr. <?php echo $rows['fname']; ?> </strong><?php echo $rows['lname']; ?></h4>
                            <span class="text-muted col-white"><?php echo $rows['speciality_1']; ?></span>
                            <div class="mt-10">
